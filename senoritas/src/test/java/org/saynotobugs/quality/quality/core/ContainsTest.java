    ...
    void testSingle()
    {
        assertThat(new Contains<>(123),
            new AllOf<>(
                ...
                new Fails<Iterable<? extends Integer>>(new Seq<>(1, 2, 3), new DescribesAs("did not contain <123>")),
    ...
    void testMultiple()
    {
        assertThat(new Contains<>(1, 2, 3),
            new AllOf<>(
                ...
                new Fails<Iterable<? extends Integer>>(new Seq<>(1, 2, 2, 2), new DescribesAs("{ ...\n  did not contain <3> }")),
    ...
    void testMultipleMatchers()
    {
        assertThat(new Contains<>(new LessThan<>(1), new EqualTo<>(2), new GreaterThan<>(3)),
            new AllOf<>(
                ...
                new Fails<Iterable<? extends Integer>>(new Seq<>(-10, 5, 6, 7), new DescribesAs("{ ...\n  did not contain <2>\n  ... }")),
                new Fails<Iterable<? extends Integer>>(new Seq<>(1, 2, 2, 10, 100), new DescribesAs("{ did not contain less than <1>\n  ... }")),
