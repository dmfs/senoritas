...
import org.saynotobugs.senoritas.matcher.rxjava3.adapters.PublishSubjectAdapter;
...
public final class TransformsObservable<Up, Down> implements Matcher<Function<? super TestScheduler, ? extends ObservableTransformer<Up, Down>>>
{
    ...
    public Verdict match(Function<? super TestScheduler, ? extends ObservableTransformer<Up, Down>> actual)
    {
        ...
        return new AllOfFailingFast<>(
            new Expanded<>(e -> e.matchers(t, new PublishSubjectAdapter<>(upstream)), mEvents)
        ).match(testAdapter);
    }
