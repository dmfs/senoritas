...
{
    @SafeVarargs
    public ObservableThat(Function<? super TestScheduler, ? extends Matcher<? super RxTestAdapter<T>>>... events)
    {
        this(new Seq<>(events));
    }


    public ObservableThat(Iterable<? extends Function<? super TestScheduler, ? extends Matcher<? super RxTestAdapter<T>>>> events)
    {
